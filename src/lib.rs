...
pub mod f32 {
    use crate::{Schema, Point, ArrayVec, Decoder, Timestamp};
    ...
    mod tests {
        ...
        use crate::f32::{F32Enc, F32Dec, F32};
...
pub mod io {
    ...
    use crate::block::{Block, BlockSpec, BLOCK_SIZE};
    use std::collections::HashMap;
...
pub mod server {
    use crate::{Schema, Timestamp, Point};
    use crate::index::TimestampIndex;
    use crate::block::{BlockSpec, BLOCK_TAIL_SIZE, BLOCK_SIZE, Block};
    use crate::cache::Cache;
    use crate::io::{BlockIO, SyncPolicy};
